...
\begin{table}[t]
  ...
  \begin{tabular}{@{}lr@{}}
    \toprule
    \rowcolor{HeaderGray} \thead{Metric} & \thead{rvLLM (Rust)} \\
    \midrule
...
startup time ($\sim$7\,s), and memory footprint (333\,MB RSS), while maintaining API
compatibility with the existing vLLM ecosystem. The 22-crate modular architecture
