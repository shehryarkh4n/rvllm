...
a single CUDA-graph replay per step, and real FA3 paged-prefill for
prompt ingest, rvLLM~v3 reaches
...
\textbf{42{,}030~tok/s} at $N\!=\!512$ (1.16$\times$ vLLM 0.19 at the same batch; 1.14--1.23$\times$ consistently across $N\!=\!128/256/512$) and \textbf{63.8\,ms TTFT at $N\!=\!128$} (real FA3 paged-prefill; 12.0$\times$ faster than the 16-step eager faux-prefill stand-in it replaces) serving Qwen2.5-7B in FP8 on a single H100, with
...
attention biases that v2 had silently omitted, routing every FP8
...
the engine the rest of the way.
